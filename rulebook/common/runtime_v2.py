"""v2 runtime chain —— answer-blind library retrieval → Compiler → Rewrite.

与 pipeline_v2 的开发期流程（含 Auditor / Extractor，看 gold）严格分离。
...
from .llm_nodes_v2 import run_action_compiler, run_hint_instantiation, run_memory_rewrite
from .local_schema_v2 import build_local_schema_view
from .role_graph_normalizer_v2 import RoleGraphNormalizer
from .trigger_contract_v2 import is_contract_runtime_executable, sanitize_trigger_contract
