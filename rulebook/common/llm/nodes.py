...
- ``call_llm`` 已含 JSON 容错重试（common/llm.utils.py）
...
def _coerce_output_contract(value: Any):
    ...
    from method.EEA.rulebook.common.core.vocabulary import OutputContract
...
def _coerce_locus(value: Any):
    ...
    from method.EEA.rulebook.common.core.vocabulary import Locus
...
def _output_shape_delta_from_code_prepared(code_prepared: Dict[str, Any]):
    from method.EEA.rulebook.common.core.data_structures import OutputShapeDelta
...
def run_wrong_case_auditor(
    *,
    ...
    CaseAudit
    """
    from method.EEA.rulebook.common.core.data_structures import CaseAudit, Confidence, Locus
    from method.EEA.rulebook.common.llm.prompts import build_wrong_case_auditor_prompt
    from method.EEA.rulebook.common.llm.utils import call_llm
...
def run_error_instance_extractor(
    *,
    ...
    ``code_prepared`` 由 ``code_preprocess.preprocess_case`` 的返回构成，至少含：
    ...
    from method.EEA.rulebook.common.llm.prompts import build_error_instance_extractor_prompt
    from method.EEA.rulebook.common.core.vocabulary import Locus, OpFamily, OutputContract, TargetFamily
    from method.EEA.rulebook.common.llm.utils import call_llm
...
def run_action_compiler(
    *,
    ...
    from method.EEA.rulebook.common.llm.prompts import build_action_compiler_prompt
    from method.EEA.rulebook.common.llm.utils import call_llm
...
def run_memory_rewrite(
    *,
    ...
    在 memory 未命中时无开销。
    """
    from method.EEA.rulebook.common.core.data_structures import ActionRealizationTrace, EditScope, SqlEditTrace
    from method.EEA.rulebook.common.llm.prompts import build_memory_rewrite_prompt
    from method.EEA.rulebook.common.llm.utils import call_llm
...
def run_hint_instantiation(
    *,
    ...
    """
    from method.EEA.rulebook.common.llm.prompts import build_hint_instantiation_prompt
    from method.EEA.rulebook.common.llm.utils import call_llm
