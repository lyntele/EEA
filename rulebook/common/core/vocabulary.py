...
class PredManifestationType(str, Enum):
    ...
    # Execution-driven deterministic tags (see execution_compare.py):
...
# 否则 runtime 永远命中不了（详见 runtime.retrieve_groups）
...
# 见 data_structures.GroupSummary 的 `slot_required_or_optional`
