...
def _call_shared_insight_judge(
    *,
    ...
    from method.EEA.rulebook.common.llm.prompts.shared_insight_judge import build_shared_insight_judge_prompt
...
def _required_signals_for_branch(
    ...
    ``runtime.build_current_case_signals``.  They do not include table names,
