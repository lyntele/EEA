...
管线：
    raw case (question/evidence/pred/gold + db) →
        1. code_preprocess.preprocess_case  (deterministic)
        2. _build_runtime_case_view              (deterministic, 把 candidate tags 收束成 QuestionContract)
        3. llm.nodes.run_wrong_case_auditor   (LLM)
        4. llm.nodes.run_error_instance_extractor  (LLM)
...
from method.EEA.rulebook.common.io.execution_compare import run_execution_comparison, serialize_execution_comparison
...
def run_error_instance_pipeline(
    *,
    ...
    if run_compiler:
        ...
        from method.EEA.rulebook.common.runtime.runtime import build_runtime_case_view as build_answer_blind_runtime_case_view
