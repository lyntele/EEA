...
def _load_or_init_library(
    *,
    ...
    if resume and path.exists():
        ...
        from method.EEA.rulebook.common.trigger_contract_v2 import (  # noqa: WPS433
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    from method.EEA.rulebook.common.accumulate_v2 import accumulate_wrong_case  # noqa: WPS433
    from method.EEA.rulebook.common.data_structures_v2 import LibraryStateV2  # noqa: WPS433
    from method.EEA.rulebook.common.evolution_v2 import (  # noqa: WPS433
        evolve_library_with_replay,
        freeze_library_manifest,
    )
    from method.EEA.rulebook.common.execution_compare_v2 import run_execution_comparison  # noqa: WPS433
