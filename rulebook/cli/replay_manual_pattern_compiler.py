...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    from method.EEA.rulebook.common.llm.nodes import run_action_compiler  # noqa: WPS433
    from method.EEA.rulebook.common.runtime.runtime import build_runtime_case_view  # noqa: WPS433
