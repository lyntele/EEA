...
from method.EEA.rulebook.common.action_compiler_v2 import (
    _current_output_shape_for_compiler,
    _variant_requires_relation_reroute,
    enumerate_candidates,
)
from method.EEA.rulebook.common.accumulate_v2 import error_instance_to_singleton
from method.EEA.rulebook.common.evolution_v2 import (
...
from method.EEA.rulebook.common.family_formation_v2 import (
    _program_structural_skeleton,
    build_family_from_groups,
)
from method.EEA.rulebook.common.pipeline_v2 import _build_runtime_case_view
from method.EEA.rulebook.common.program_coverage_v2 import CompilerCoverageValidator
from method.EEA.rulebook.common.promotion_v2 import (
...
from method.EEA.rulebook.common.runtime_v2 import (
...
from method.EEA.rulebook.common.repair_program_normalizer_v2 import RepairProgramNormalizer
from method.EEA.rulebook.common.role_graph_normalizer_v2 import RoleGraphNormalizer
from method.EEA.rulebook.common.signal_summary_v2 import (
    build_formation_signals,
    build_trigger_contract,
)
from method.EEA.rulebook.common.shared_program_synthesizer_v2 import (
    coverage_for_singleton_program,
    singleton_program_from_ir,
    synthesize_shared_program,
)
from method.EEA.rulebook.common.trigger_contract_v2 import (
    ensure_materialized_trigger_contract,
    is_contract_runtime_executable,
)
from method.EEA.rulebook.common.structure_family import cached_ast_signature
from method.EEA.rulebook.common.vocabulary_v2 import (
    ActionPrimitive,
    Confidence,
    GroupStatus,
    GroupType,
...
def _default_shared_insight_judge(monkeypatch):
    ...
    from method.EEA.rulebook.common import family_formation_v2
    from method.EEA.rulebook.common import shared_program_synthesizer_v2

    monkeypatch.setattr(
        shared_program_synthesizer_v2,
...
def test_synthesizer_prefers_effect_bucket_before_legacy_op_buckets(monkeypatch) -> None:
    ...
    monkeypatch.setattr(shared_program_synthesizer_v2, "_ops_by_bucket", lambda _ir: {})
    monkeypatch.setattr(
        shared_program_synthesizer_v2, "_ops_by_generalized_bucket", lambda _ir: {}
    )
...
def test_family_formation_uses_program_compatibility_without_overmerging_grain() -> None:
    ...
    family_library, _ = __import__(
        "method.EEA.rulebook.common.family_formation_v2",
...
def test_summary_uses_c0_not_top1_for_gain_accounting() -> None:
    from method.EEA.rulebook.cli.run_online_e2e_validation_v2 import _summary_payload
...
def test_compiler_dry_run_reports_branch_selection_ambiguity(monkeypatch) -> None:
    from method.EEA.rulebook.common import runtime_v2
...
def _patch_compiler_llm(monkeypatch, selected_candidate_ids: list[str]) -> None:
    ...
    monkeypatch.setattr(
        "method.EEA.rulebook.common.llm_utils_v2.call_llm",
        fake_call_llm,
    )
...
def test_replay_metrics_count_only_pure_llm_rows_as_llm_selected() -> None:
    from method.EEA.rulebook.common.promotion_v2 import _metrics_from_rows
...
def test_support2_runtime_can_use_full_group_while_formal_uses_cross(monkeypatch) -> None:
    from method.EEA.rulebook.common import promotion_v2
    ...
    monkeypatch.setattr(promotion_v2, "_contract_program_issues", lambda *_, **__: [])
    monkeypatch.setattr(
        promotion_v2,
    ...
    monkeypatch.setattr(promotion_v2, "_replay_one_holdout", fake_replay_one_holdout)

    result = promotion_v2.run_promotion_test(
        group=family,
...
def test_action_primitive_support_matrix_is_fully_implemented() -> None:
    from method.EEA.rulebook.common.action_compiler_v2 import _IMPLEMENTED

    assert set(ActionPrimitive) == set(_IMPLEMENTED)


def test_prompt_contracts_reflect_current_llm_responsibilities() -> None:
    from method.EEA.rulebook.common.prompts_v2.action_compiler import ACTION_COMPILER_PROMPT
    from method.EEA.rulebook.common.prompts_v2.compatibility_judge import COMPATIBILITY_JUDGE_PROMPT
    from method.EEA.rulebook.common.prompts_v2.memory_rewrite import MEMORY_REWRITE_PROMPT
...
def test_repair_program_dependency_steps_are_not_case_id_filtered() -> None:
    from method.EEA.rulebook.common.action_compiler_v2 import _repair_program_for_canonical_op
...
def test_synthesizer_can_fallback_to_invariant_envelope_when_bucket_matching_is_unavailable(
    ...
    monkeypatch.setattr(shared_program_synthesizer_v2, "_ops_by_bucket", lambda _ir: {})
    monkeypatch.setattr(shared_program_synthesizer_v2, "_ops_by_generalized_bucket", lambda _ir: {})
...
def test_runtime_repair_brief_is_rendered_from_actions() -> None:
    from method.EEA.rulebook.common.runtime_v2 import _render_action_repair_brief
