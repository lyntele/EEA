...
### 2026-05-11 WUv2-5b / negative-guard runtime consumption deferred

- revert 范围: EEA `6ffd44f` / `3a13389` / `2e543f5`。
- 保留范围: `HistoricalRegressGuard` schema 与 `regression_negative_guards` 字段，作为 audit/logged feedback 数据结构保留；runtime 当前不消费。
